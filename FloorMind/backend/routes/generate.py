...
def generate_floorplan():
    ...
    Expected JSON payload:
    {
        ...
        "model_type": "constraint_aware",  # or "baseline"
        "seed": 42,  # optional
    ...
    try:
        ...
        prompt = data['prompt']
        model_type = data.get('model_type', 'constraint_aware')  # Default to constraint-aware
        ...
        if model_type not in ['baseline', 'constraint_aware']:
            return jsonify({'error': 'Invalid model_type. Use "baseline" or "constraint_aware"'}), 400
